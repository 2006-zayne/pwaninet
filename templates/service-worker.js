...
const CACHE_NAME = 'pwaninet-v1';
const OFFLINE_CACHE_NAME = 'pwaninet-offline-v1';
...
async function getOfflinePage() {
    ...
    try {
        ...
        console.log('Failed to fetch offline page, using fallback');
    }
    ...
    return new Response(`
        ...
        <body>
            <div class="offline-container">
                ...
                <button class="retry-button" onclick="window.location.href='/messaging/'">View Messages</button>
            </div>
