...
VAPID_SUBJECT = os.getenv('VAPID_SUBJECT', 'mailto:admin@pwaninet.app')
FIREBASE_CREDENTIALS_PATH = os.getenv('FIREBASE_CREDENTIALS_PATH', os.path.join(BASE_DIR, 'firebase-adminsdk.json'))
