...
ALLOWED_HOSTS = [
    ...
    for host in os.environ.get(
        'ALLOWED_HOSTS',
        'localhost,127.0.0.1,10.20.152.125,pwaninet.app,192.168.43.170,192.168.145.221,192.168.43.170,192.168.183.245,192.168.203.221,192.168.53.221,192.168.93.221,192.168.87.159,192.168.14.221,192.168.72.88,192.168.87.159,192.168.72.88,192.168.183.245,172.18.0.1,192.168.183.245,192.168.83.192'
    ).split(',')
    if host.strip()
]
