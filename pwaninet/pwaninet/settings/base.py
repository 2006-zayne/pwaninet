...
ALLOWED_HOSTS = [
    ...
    for host in os.environ.get(
        'ALLOWED_HOSTS',
        'localhost,127.0.0.1,10.20.152.125,192.168.183.245,192.168.19.221,192.168.140.221,192.168.72.88,192.168.85.117,192.168.72.88,192.168.183.245,172.18.0.1,192.168.183.245'
    ).split(',')
    if host.strip()
]
