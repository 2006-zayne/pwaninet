/**
 * PwaniNet PWA Startup Manager - Fixed Version
 * Strict launch detection - only shows splash on absolute initial app launch
 */

class PwaniNetStartupFixed {
    constructor() {
...
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', () => {
        window.pwaninetStartup = new PwaniNetStartupFixed();
    });
} else {
    // Already loaded
    window.pwaninetStartup = new PwaniNetStartupFixed();
...
window.PwaniNetStartupFixed = PwaniNetStartupFixed;
