...
export class MessageService {
    ...
    normalizeServerMessage(raw) {
        ...
        // Add sender avatar metadata if present
        if (raw.sender?.profile_pic_url) {
            metadata.sender_avatar = raw.sender.profile_pic_url;
        } else if (raw.sender?.profile_pic) {
            metadata.sender_avatar = raw.sender.profile_pic;
        }
