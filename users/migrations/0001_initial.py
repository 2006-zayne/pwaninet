    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('global_role', models.CharField(choices=[('PRESIDENT', 'President'), ('DELEGATE', 'Delegate'), ('VERIFIED', 'Verified'), ('NORMAL', 'Normal')], default='NORMAL', max_length=20)),
                ...
                ('year', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='courses.year')),
            ],
            options={
                'verbose_name': 'user',
