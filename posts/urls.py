...
urlpatterns = [
    ...
    path('api/posts/<int:pk>/images/<int:image_id>/like/', views.PostViewSet.as_view({'post': 'image_like'}), name='post_image_like'),
    path('api/posts/<int:pk>/images/<int:image_id>/comments/', views.PostViewSet.as_view({'get': 'image_comments', 'post': 'image_comments'}), name='post_image_comments'),
